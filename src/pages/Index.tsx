        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <h1 className="text-5xl md:text-6xl font-display font-bold leading-[1.1] text-foreground lg:text-5xl">Increase Sales With Your Brand's Very Own  Personal AI Stylist </h1>
      ...
      <section id="features" className="py-20 bg-background">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <FeatureCard icon={<Sparkles className="w-6 h-6" />} title="AI-Powered Recommendations" description="Our AI creates personalized outfit combinations that increase average order value by 35%" />
            <FeatureCard icon={<Calendar className="w-6 h-6" />} title="Seamless Integration" description="One-click integration with Shopify and WooCommerce. Get up and running in minutes." />
            <FeatureCard icon={<Users className="w-6 h-6" />} title="Customer Engagement" description="Let customers save outfits, build wish lists, and get personalized style recommendations" />
            <FeatureCard icon={<TrendingUp className="w-6 h-6" />} title="Analytics Dashboard" description="Track which products are trending, outfit performance, and customer preferences" />
          </div>
        </div>
      </section>
