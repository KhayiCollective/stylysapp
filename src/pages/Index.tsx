      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-md border-b border-border/50">
        <div className="editorial-container flex items-center justify-between h-16">
          <Link to="/" className="flex items-center gap-2">
            ...
            <span className="font-display text-xl font-semibold">Outfit Builder</span>
          </Link>
      ...
      <section className="pt-32 pb-20 md:pt-40 md:pb-32">
        <div className="editorial-container">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="font-display text-5xl md:text-7xl lg:text-8xl font-medium leading-[0.95] mb-8 animate-slide-up">
              AI-Powered
              <br />
        ...
        <div className="editorial-container">
          <div className="grid md:grid-cols-3 gap-8">
            <FeatureCard
              ...
              description="Upload your product catalog and let our AI understand your inventory, styles, and color palettes."
              delay={1}
            />
            <FeatureCard
              icon={<Sparkles className="w-6 h-6" />}
              title="Smart Outfit Generation"
              description="Rule-based styling that considers category balance, color harmony, and fit compatibility."
              delay={2}
            />
            <FeatureCard
              icon={<BarChart3 className="w-6 h-6" />}
              title="Increase AOV"
              description="Complete-the-look recommendations that drive higher cart values and customer satisfaction."
              delay={3}
            />
          </div>
        </div>
        ...
        <div className="editorial-container text-center">
          ...
          <Link to="/dashboard">
            <Button 
              variant="outline" 
              size="xl" 
              className="border-background/30 text-background hover:bg-background hover:text-foreground rounded-none uppercase tracking-widest text-xs font-semibold"
            >
      ...
      <footer className="py-8 border-t border-border">
        <div className="editorial-container flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="font-display text-sm">AI Outfit Builder</span>
          </div>
          <p className="text-sm text-muted-foreground">
            © 2024 AI Outfit Builder. Built for fashion e-commerce.
          </p>
        </div>
      </footer>
    </div>
